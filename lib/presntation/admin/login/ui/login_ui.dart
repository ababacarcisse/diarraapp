...
class AdminLoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> signIn() async {
      ...
      final user =  read(adminLoginProvider(credentials).future);

      if (user != null) {
        // Administrator is logged in, navigate to the admin page.
        router.go('/adminPage');
      } else {
        // Administrator is not logged in, display an error message.
      }
    }
